...
static void save_device_state(struct net_device *dev)
{
    ...
    shadow->saved_state.msg_enable = 0; 
...
static void recovery_work_fn(struct work_struct *work) {
    ...
    /* In a real implementation for thousands of tests, we will need to:
